namespace TriviaPursuit
{
   partial class FormAPropos
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.label1.Text = "Trivia Diamond";
         ...
         this.label2.Size = new System.Drawing.Size(273, 88);
         this.label2.TabIndex = 8;
         this.label2.Text = "Il s\'agit d\'une application blab lslall ablabl balbala blablabla  blablablabla bl" +
    "ablab werwer wer wer wr ablablabl  ablabl ablablabla blablabllbaww ";
